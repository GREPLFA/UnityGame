...
public class Moster_2 : MonoBehaviour
{
    float speed = 6.0f;
    float move;
    ...
    void Attack()
    {
        if (this.transform.position.x - Play.position.x < 1.7f && this.transform.position.x - Play.position.x > -1.7f && !animator.GetCurrentAnimatorStateInfo(0).IsName("attack2"))
        {
            attackChcek = true;
